//xadreco version 4.0. Chess engine compatible with XBoard/WinBoard Protocol (C)
...
//-----------------------------------------------------------------------------
//
//xadreco version 4.0. Motor de xadrez compatível com o XBoard/WinBoard (C)
//Copyright (C) 2004, Ruben Carlo Benante.
//
...
const float version = 4.0;	//Versão do programa
			    //program version
...
para obter detalhes.\n\n",
	  ...
	  //printf("tellicsnoalias kibitz Hello from Xadreco v.4.0\n");
      }
...
//        difclock/=10;
	...
	printf ("%d %d %d %d ", nivel, result.valor, difclock / 10,
		totalnodo);
...
//                              getchar();
	    ...
	    
	    {
			  ...
			  "tellopponent Xadreco v.4.0 para XBoard/WinBoard, baseado no Algoritmo Minimax, por Ruben Carlo Benante, 04/06/04.\n");
...
//                                              scanf("%c",&com); //com=getche();
		...
		("	nivel  : muda o nivel de dificuldade atual.\n");
